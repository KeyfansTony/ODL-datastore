 ...
 */
package org.opendaylight.hello.impl.datastore.listener;
...
public class DatastoreConfigChangeListener implements DataChangeListener, DataTreeChangeListener<DatastoreConfig> {
    ...
    private ListenerRegistration<DataChangeListener> lisReg;
    private ListenerRegistration<DatastoreConfigChangeListener> listenerReg;
