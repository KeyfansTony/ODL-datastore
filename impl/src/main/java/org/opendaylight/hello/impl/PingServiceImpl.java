...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.ping.rev170826.PingHostsInput;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.ping.rev170826.PingHostsOutput;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.ping.rev170826.PingHostsOutputBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.ping.rev170826.PingService;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.ping.rev170826.ping.hosts.input.DestinationAll;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.ping.rev170826.ping.hosts.output.EchoResultAll;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.ping.rev170826.ping.hosts.output.EchoResultAllBuilder;
